 ...
 */
package com.deepde.paq.aop;

import com.alibaba.fastjson.JSON;
import com.deepde.paq.extension.AppRuntimeEnv;
...
public class LogAspect {
    ...
    @Pointcut("execution (* com.deepde.paq.controller..*.*(..))")
    public void controllerLogAop() {
    }

    @Pointcut("execution (* com.deepde.paq.service..*.*(..))")
